...
h_conv1 = tf.nn.relu(tf.layers.conv2d(x_image, 32, (3, 3), padding="same"))
h_conv1 = tf.nn.relu(tf.layers.conv2d(h_conv1, 32, (3, 3), padding="same"))
h_conv1 = tf.nn.relu(tf.layers.conv2d(h_conv1, 32, (3, 3), padding="same"))
h_pool1 = max_pool_2x2(h_conv1)

# 16x16x32 -> 8x8x64
h_conv2 = tf.nn.relu(tf.layers.conv2d(h_pool1, 64, (3, 3), padding="same"))
h_conv2 = tf.nn.relu(tf.layers.conv2d(h_conv2, 64, (3, 3), padding="same"))
h_conv2 = tf.nn.relu(tf.layers.conv2d(h_conv2, 64, (3, 3), padding="same"))
